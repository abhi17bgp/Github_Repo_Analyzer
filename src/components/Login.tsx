...
//   return (
//     <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-6 sm:p-8 w-full max-w-sm sm:max-w-md border border-white/20 transform transition-all duration-300 hover:scale-105">
//       <div className="text-center mb-8">
//         <div className="flex items-center justify-center mb-4">
//           <div className="p-3 bg-blue-500/20 rounded-full">
//             <Github className="w-8 h-8 sm:w-10 sm:h-10 text-blue-400" />
//           </div>
//         </div>
...
//             className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 hover:bg-white/15 focus-ring"
...
//         <button
//           type="submit"
//           disabled={loading || (!isLogin && (!usernameStatus.available || usernameStatus.checking))}
//           className="w-full flex items-center justify-center px-4 py-3 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-transparent disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 transform hover:scale-105 active:scale-95 focus-ring"
//         >
//           {loading ? (
